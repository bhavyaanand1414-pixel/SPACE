"""Add PS26227 semantic search and provenance tables

Revision ID: c4a1879ce836
Revises: 0001_initial_schema
Create Date: 2026-09-15 01:11:52.625290
...
def upgrade() -> None:
    ...
    sa.Column('source_scene_path', sa.String(length=1024), nullable=True),
    ...
    op.create_index(op.f('ix_provenance_entity_type'), 'provenance', ['entity_type'], unique=False)
    ...
    sa.Column('original_subcategory', sa.String(length=100), nullable=False),
    sa.Column('original_confidence', sa.Float(), nullable=False),
    sa.Column('corrected_category', sa.String(length=100), nullable=True),
    sa.Column('corrected_subcategory', sa.String(length=100), nullable=True),
    sa.Column('status', sa.String(length=50), nullable=False),
    sa.Column('reviewer_name', sa.String(length=100), nullable=False),
    sa.Column('notes', sa.Text(), nullable=True),
    sa.Column('model_version', sa.String(length=50), nullable=False),
    sa.Column('is_active_learning_candidate', sa.Boolean(), nullable=False),
    sa.Column('source_scene_ids', sa.JSON(), nullable=True),
    sa.Column('processing_history', sa.JSON(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_review_records_analysis_id'), 'review_records', ['analysis_id'], unique=False)
    ...
    sa.Column('bounds_geom', geoalchemy2.types.Geometry(geometry_type='POLYGON', srid=4326, dimension=2, from_text='ST_GeomFromEWKT', name='geometry'), nullable=True),
    ...
    sa.Column('cloud_coverage_pct', sa.Float(), nullable=True),
    sa.Column('scl_path', sa.String(length=1024), nullable=True),
    ...
    op.create_index(op.f('ix_scenes_acquisition_datetime'), 'scenes', ['acquisition_datetime'], unique=False)
    op.create_index(op.f('ix_scenes_ingestion_status'), 'scenes', ['ingestion_status'], unique=False)
    ...
    sa.Column('satellite', sa.String(length=100), nullable=True),
    sa.Column('sensor', sa.String(length=100), nullable=True),
    sa.Column('cloud_fraction', sa.Float(), nullable=False),
    ...
    op.create_index(op.f('ix_tiles_acquisition_datetime'), 'tiles', ['acquisition_datetime'], unique=False)
    op.create_index(op.f('ix_tiles_faiss_idx'), 'tiles', ['faiss_idx'], unique=False)
    op.create_index(op.f('ix_tiles_satellite'), 'tiles', ['satellite'], unique=False)
    op.create_index(op.f('ix_tiles_scene_id'), 'tiles', ['scene_id'], unique=False)
    op.add_column('change_regions', sa.Column('geom', geoalchemy2.types.Geometry(srid=4326, dimension=2, from_text='ST_GeomFromEWKT', name='geometry').with_variant(sa.JSON(), 'sqlite'), nullable=True))
